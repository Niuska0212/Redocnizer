<p align="center"> <img src="ui/assets/logo_redocnizer.png" alt="REDOCNIZER Logo" width="200"> </p>

📄 REDOCNIZER - Gestión Inteligente de Contratos

GitHub release License Python PySide6
...
➔ Descargar la ultima version de REDOCNIZER(.exe)
...
TensorFlow/Keras: incluidas como dependencia porque el repositorio conserva el pipeline de entrenamiento de un modelo CRNN propio (ver Notas de alcance), aunque no se usan en el flujo de reconocimiento activo
🚀 Instalación Rápida
...
GUIA_USO.md	Guía completa de uso del programa
MODULOS.md	Cumplimiento de módulos requeridos
ARQUITECTURA.md	Diseño y arquitectura del sistema
REQUERIMIENTOS.md	Especificaciones técnicas y requisitos
...
Ver MODULOS.md — este documento aún describe la arquitectura distribuida con CRNN y necesita revisarse contra el alcance real listado arriba antes de usarse como evidencia final ante el comité.
...
Ver GUIA_USO.md para guía completa (nota: puede incluir pasos de sincronización con la nube que ya no aplican, ver aviso arriba).

🤝 Contribuciones

Este es un proyecto académico de titulación y, por el momento, no se aceptan contribuciones externas ni cambios en el código base por parte de terceros para mantener la integridad de la entrega institucional. Agradecemos su comprensión.
